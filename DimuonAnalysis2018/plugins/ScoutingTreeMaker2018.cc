...
class ScoutingTreeMaker2018 : public edm::one::EDAnalyzer<edm::one::SharedResources, edm::one::WatchRuns, edm::one::WatchLuminosityBlocks> {
	public:
		explicit ScoutingTreeMaker2018(const edm::ParameterSet&);
		~ScoutingTreeMaker2018();
...
ScoutingTreeMaker2018::ScoutingTreeMaker2018(const edm::ParameterSet& iConfig): 
...
ScoutingTreeMaker2018::~ScoutingTreeMaker2018() {
}

void ScoutingTreeMaker2018::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
    using namespace edm;
    using namespace std;
...
void ScoutingTreeMaker2018::beginJob() {
...
void ScoutingTreeMaker2018::endJob() {
}

void ScoutingTreeMaker2018::beginRun(edm::Run const& iRun, edm::EventSetup const& iSetup) {
    // HLT paths
...
void ScoutingTreeMaker2018::endRun(edm::Run const&, edm::EventSetup const&) {
}

void ScoutingTreeMaker2018::beginLuminosityBlock(edm::LuminosityBlock const& iLumi, edm::EventSetup const&) {
}

void ScoutingTreeMaker2018::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&) {
}

void ScoutingTreeMaker2018::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
	edm::ParameterSetDescription desc;
	desc.setUnknown();
	descriptions.addDefault(desc);
}

DEFINE_FWK_MODULE(ScoutingTreeMaker2018);
